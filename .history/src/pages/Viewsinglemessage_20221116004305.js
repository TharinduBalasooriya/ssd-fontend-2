...
export default function Viewsinglemessage() {
    ...
    return (
        <div style={{ paddingTop: '6vh' }}>
            ...
            <Row>
            <Col>
                    <div style={{ paddingRight: '2vh',paddingLeft:'5vh', paddingTop: '2vh', paddingBottom: '2vh' }}>
                        <Card >
                            <div style={{ paddingLeft: '2vh', paddingRight: '2vh', paddingTop: '5vh', paddingBottom: '2vh' }}>
                                <Card >
                                    <Card.Body>
                                        ...
                                        <div style={{ paddingLeft: '4vh' }}>
                                            ...
                                            <h6 > Title : {message.title}</h6>
                                            <h6 > Description : {message.description}</h6>
