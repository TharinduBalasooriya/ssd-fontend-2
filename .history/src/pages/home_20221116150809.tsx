                ...
                if (state.isAuthenticated && currentUser && currentUser.role === 'admin') {
                    ...
                    return (
                        <div className="content">
                           ...
                           <Card.Img variant="top" src="https://www.pngkit.com/png/full/824-8246267_time-left-user-icon-round-png.png" style={{width:'20vh'}}/>
                            </div>
                           <div style={{paddingTop:'5vh',paddingLeft:'2vh'}}>
                            ...
                            <div style={{paddingBottom:'2vh',paddingLeft:'2vh'}}>
